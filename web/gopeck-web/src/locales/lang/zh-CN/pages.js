export default {
    'pages.layouts.userLayout.title': 'Gopeck是一个高性能、可扩展的分布式压力测试平台',
    ...
    'pages.welcome.alertMessage': 'Gopeck是一个高性能、可扩展的分布式压力测试平台',
    ...
    'pages.user.profile.tab.security.form.update_password': '更新密码',

    'pages.user.profile.tab.security.form.password.update_success': '密码修改成功',
    'pages.user.profile.tab.security.form.password.update_failed': '密码修改失败',
    'pages.user.profile.tab.basic.update_success': '用户信息修改成功',
    'pages.user.profile.tab.basic.update_failed': '用户信息修改失败',

    'pages.user.profile.tab.basic.form.username': '昵称',
    'pages.user.profile.tab.basic.form.email': '邮箱',
}
